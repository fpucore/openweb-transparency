...
content.innerHTML = `
  <div style="font-weight: 600; font-size: 15px; margin-bottom: 6px;">
    Linux Foundation Financial Report (as of 2025)
  </div>
  <div style="margin-bottom: 4px;">
    Revenue: <strong>(US)$311.3 million</strong>
    | Assets: <strong>(US)$224.0 million</strong> <br>
    CEO compensation: <strong>(US)$950,698</strong>
    | Linux kernel costs: <strong>(US)$8.4 million</strong>
  </div>
  <div style="font-size: 13px; opacity: 0.9; margin-top: 12px;">
    ...
    <a href="https://www.linuxfoundation.org/about/annual-report"
       target="_blank"
       style="color: #a5d8ff; text-decoration: none; border-bottom: 1px dotted #a5d8ff;">
      Annual Report
    </a>
    <div style="font-weight: 600; font-size: 10px; margin-top: 12px;">
      Released under BSD 2-Clause License | Mod by Chris McGimpsey-Jones
    </div>
  </div>`;
