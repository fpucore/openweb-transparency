...
content.innerHTML = `
  <div style="font-weight: 600; font-size: 15px; margin-bottom: 6px;">
    Mozilla Foundation Financial Report (as of 2024)
  </div>
  <div style="margin-bottom: 4px;">
    Revenue: <strong>(US)$680.0 million</strong>
    | Assets: <strong>(US)$1.4 billion</strong> <br>
    CEO compensation: <strong>(US)$6.9 million</strong>
  </div>
  <div style="font-size: 13px; opacity: 0.9; margin-top: 12px;">
    Sources:
    <a href="https://projects.propublica.org/nonprofits/organizations/200097189"
       target="_blank"
       style="color: #a5d8ff; text-decoration: none; border-bottom: 1px dotted #a5d8ff;">
      IRS Form 990
    </a>,
    <a href="https://www.mozillafoundation.org/meet-mozilla/annual-reports-and-financials/"
       target="_blank"
       style="color: #a5d8ff; text-decoration: none; border-bottom: 1px dotted #a5d8ff;">
      Annual Report
    </a>
