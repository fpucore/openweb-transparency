...
content.innerHTML = 
  '<div style="font-weight: 600; font-size: 15px; margin-bottom: 6px;">' +
    'Wikimedia Foundation Financial Reporting (as of 2025)' +
  '</div>' +
  '<div style="margin-bottom: 4px;">' +
    'Revenue: <strong>(US)$189.7 million</strong> ' +
    '| Assets: <strong>(US)$310.8 million</strong> <br  >' +
    'Salaries: <strong>(US)$114.0 million</strong> | Hosting: <strong>(US)$3.5 million</strong>' +
  '</div>' +
  '<div style="font-size: 13px; opacity: 0.9; margin-top: 12px;">' +
    'Source: ' +
    '<a href="https://wikimediafoundation.org/annualreports/2024-2025-annual-report/" ' +
       'target="_blank" ' +
...
if (isWikipediaArticle()) {
  ...
  if (grokTitle) {
    ...
    grokLink.textContent = "Check if this page is available on Grokipedia";
