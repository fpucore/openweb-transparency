...
content.innerHTML = `
  <div style="font-weight: 600; font-size: 15px; margin-bottom: 6px;">
    Tor Project Inc Financial Report (as of 2024)
  </div>
  <div style="margin-bottom: 4px;">
    Revenue: <strong>(US)$8.0 million</strong>
    | Assets: <strong>(US)$7.0 million</strong> <br>
    Executive Director compensation: <strong>(US)$173,648</strong>
  </div>
  <div style="font-size: 13px; opacity: 0.9; margin-top: 12px;">
    ...
    <a href="https://www.torproject.org/about/reports/"
       target="_blank"
       style="color: #a5d8ff; text-decoration: none; border-bottom: 1px dotted #a5d8ff;">
      Transparency Report
    </a>
