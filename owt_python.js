...
content.innerHTML = `
  <div style="font-weight: 600; font-size: 15px; margin-bottom: 6px;">
    Python Software Foundation Financial Report (as of 2023)
  </div>
  <div style="margin-bottom: 4px;">
    Revenue: <strong>(US)$4.2 million</strong>
    | Assets: <strong>(US)$5.45 million</strong> <br>
    Executive Director compensation: <strong>(US)$154,054</strong>
    | Costs: <strong>(US)$4.3 million</strong>
  </div>
